...
from model.cw_ner.functions.iniatlize import init_cnn_weight
from model.cw_ner.functions.iniatlize import init_maxtrix_weight
from model.cw_ner.functions.iniatlize import init_vector
